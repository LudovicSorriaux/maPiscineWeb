...
const char INDEX_NAME_56[] PROGMEM = "pacAutonome";        // 56
const char INDEX_NAME_57[] PROGMEM = "coefCL";              // 57
const char INDEX_NAME_58[] PROGMEM = "coefPHm";             // 58
const char INDEX_NAME_59[] PROGMEM = "debitPompeP";        // 59
...
const char INDEX_NAME_74[] PROGMEM = "fwVersion";          // 74
const char INDEX_NAME_75[] PROGMEM = "lastPHVal";          // 75
const char INDEX_NAME_76[] PROGMEM = "lastRedoxVal";       // 76
const char INDEX_NAME_77[] PROGMEM = "lastPHTime";         // 77
const char INDEX_NAME_78[] PROGMEM = "lastRedoxTime";      // 78
